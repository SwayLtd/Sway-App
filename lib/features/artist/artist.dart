                        ...
                        FutureBuilder<List<Map<String, dynamic>>>(
                          ...
                          builder: (context, eventSnapshot) {
                            if (eventSnapshot.connectionState ==
                              ...
                              // Remove duplicate events based on event ID, keeping the first occurrence.
                              final uniqueEvents = <Event>{};
                              final filteredUpcomingEvents =
                                  upcomingEvents.where((event) {
                                return uniqueEvents.add(
                                    event); // Adds event if not already in the set.
                              }).toList();
                              ...
                              final List<Event> displayEvents =
                                  filteredUpcomingEvents.length > displayCount
                                      ? filteredUpcomingEvents.sublist(
                                          0, displayCount)
                                    ...
                                    children: [
                                      ...
                                      if (filteredUpcomingEvents.length >
                                        ...
                                        IconButton(
                                          icon: const Icon(Icons.arrow_forward),
                                          onPressed: () {
                                            showEventModalBottomSheet(context,
                                                filteredUpcomingEvents);
                                          },
                                        ),
                                    ],
