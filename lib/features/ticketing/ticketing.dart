              ...
              return FutureBuilder<List<Event>>(
                ...
                builder: (context, eventSnapshot) {
                  if (eventSnapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final upcomingEvents = events.where((event) => event.dateTime.isAfter(DateTime.now())).toList();
                    final pastEvents = events.where((event) => event.dateTime.isBefore(DateTime.now())).toList();
