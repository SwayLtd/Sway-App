...
class AppTheme {
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    backgroundColor: Colors.grey[100], // Légèrement grisé pour harmoniser avec le fond
...
static ThemeData dark = ThemeData(
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    backgroundColor: Colors.grey[900], // Fond de la BottomNavigationBar légèrement grisé
    selectedItemColor: Colors.amber,
